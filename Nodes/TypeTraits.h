...
public:
    ...
    enum { isStdUnsignedInt = IndexOf<Private::StdUnsignedInts, UnqualifiedType>::value >= 0 ||
           IndexOf<Private::StdUnsignedInts,
           typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0};
    enum { isStdSignedInt   = IndexOf<Private::StdSignedInts, UnqualifiedType>::value >= 0 ||
           IndexOf<Private::StdSignedInts,
           typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0};
    enum { isStdIntegral    = isStdUnsignedInt || isStdSignedInt ||
           IndexOf<Private::StdOtherInts, UnqualifiedType>::value >= 0 ||
           IndexOf<Private::StdOtherInts,
           typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0};
    enum { isStdFloat       = IndexOf<Private::StdFloats, UnqualifiedType>::value >= 0 ||
           IndexOf<Private::StdFloats,
           typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0};
